...
public partial class GameEntity {
    ...
    public void AddMovementSpeed(float newMovementSpeedValue) {
        ...
        component.MovementSpeedValue = newMovementSpeedValue;
        AddComponent(index, component);
    }

    public void ReplaceMovementSpeed(float newMovementSpeedValue) {
        var index = GameComponentsLookup.MovementSpeed;
        var component = (MovementSpeedComponent)CreateComponent(index, typeof(MovementSpeedComponent));
        component.MovementSpeedValue = newMovementSpeedValue;
